...
export default {
  ...
  computed: {
    ...
    remoteButtonState() {
      ...
      return this.readRemoteMixerValue("var.mtk.rec.currentState");
    },
    stateClass() {
      return (this.state === true) ? 'active' : '';
    },
    remoteVarSession() {
      return this.readRemoteMixerValue("var.mtk.rec.session");
    },
    remoteVarBusy() {
      return this.readRemoteMixerValue("var.mtk.rec.busy");
    },
    remoteVarTime() {
      return this.readRemoteMixerValue("var.mtk.rec.time");
    },
    remoteVarMtkCurrentState() {
      return this.readRemoteMixerValue("var.mtk.currentState");
    },
